...
יש לך גישה לחיפוש באינטרנט בזמן אמת — השתמש בו לקבל מידע עדכני על מחירי טיסות, מלונות, אטרקציות ועוד.

עזור לו עם:

- טיסות (חברות תעופה, מחירים עדכניים, טיפים לחיסכון)
...
```
// שליפת הטקסט מהתשובה (יכול להיות בלוקים מעורבים)
...
// שמור מקסימום 20 הודעות אחרונות
